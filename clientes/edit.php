...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Revisar email único, excluyendo este cliente
    ...
    if (empty($errores)) {
        $stmt = $pdo->prepare("UPDATE clientes SET nombre=:nombre, email=:email, telefono=:telefono, direccion=:direccion WHERE id=:id");
        $stmt->execute(compact('nombre','email','telefono','direccion','id'));
...
<form method="POST">
    ...
    <input type="email" name="email" value="<?php echo htmlspecialchars($c['email']); ?>" required>
